...
public class _02_FindTheHiddenButton implements ActionListener{
	...
	public void start() {
		...
		int posNum = Integer.valueOf(JOptionPane.showInputDialog("Enter a POsitive Number"));
		...
		JOptionPane.showMessageDialog(panel, "Instructins");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (buttonClicked == buttons[hiddenButton]) {
			JOptionPane.showMessageDialog(panel, "Winner!!!");
		}else {
